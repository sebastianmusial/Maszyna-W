	...
	<div class="central-unit">
		<div id="central-unit__extension-top" class="central-unit__extension">
			<div id="extension-ws" class="extension-ws" data-name="WS">
				<input type="text"
					class="element__data js-only-numbers js-quick-edit" value="0">

				<div id="extension-wyls" class="extension-wyls"></div>
			</div>
		</div>
		<div id="central-unit__base" class="central-unit__base"
			data-top-bus="magistrala adresowa" data-down-bus="magistrala danych">
			...
			<div id="acumulator" class="acumulator" data-name="AK">
				<input type="text"
					class="acumulator__data js-only-numbers js-quick-edit" value="0">
			</div>
			<div id="memory" class="memory">
				<div id="memory-address" class="memory-address" data-name="A">
					<input type="text"
						class="memory__address js-only-numbers js-quick-edit" value="0">
				</div>
				<div id="memory-data" class="memory-data" data-name="S">
					<input type="text"
						class="memory__verbal js-only-numbers js-quick-edit" value="0">
				</div>
		...
		<div id="central-unit__extension-bottom"
			class="central-unit__extension">
	...
	<div class="container-fluid control-panel">
		<div class="row">
			<div class="col-xs-5">
				<div class="row">
					<div class="col-xs-6 col-hand-controls">
						<label class="collapse-headline hand-controls"> <input
							type="checkbox" name="handControls" id="handControls"
							value="0"> <span id="MANUAL_CONTROL_CHECK_BOX">
								sterowanie ręczne </span>
						</label>
					</div>
				...
				<ul class="nav nav-tabs" id="leftTab">
					...
					<li><a href="#inOutConsole"><i
							class="glyphicon glyphicon-transfer"> </i> Konsola
							wejścia-wyjścia</a></li>
				</ul>
											...
											<div class="panel-body">
												...
												<div class="radio">
													<label> <input id="track-command" type="radio"
														name="trace-lavel" class="js-type"> <span
														id="TRACKING_LEVEL_MEDIUM_OPTION"> średni (rozkaz)
													</span>
													</label>
												</div>
												<div class="radio">
												...
												<div class="col-xs-9">
													...
													<div class="checkbox">
														<label> <input type="checkbox" name="extension8"
															...
															id="ADDITIONAL_MARKS_CHECK_BOX">dodatkowe
																znaczniki</span>
														</label>
													</div>
												</div>
			...
			<div class="col-xs-7">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="commands">jakies
						rozkazy</div>
